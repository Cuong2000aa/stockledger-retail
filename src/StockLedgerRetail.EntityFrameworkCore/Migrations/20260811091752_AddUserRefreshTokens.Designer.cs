...
namespace StockLedgerRetail.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260811091752_AddUserRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockLedgerRetail.Domain.Entities.AppUserRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("app_user_refresh_tokens", (string)null);
                });
            ...
            modelBuilder.Entity("StockLedgerRetail.Domain.Entities.GoodsReceipt", b =>
                {
                    ...
                    b.HasIndex("Status", "ReceiptDate", "CreatedAt")
                        .IsDescending(false, true, true);

                    b.HasIndex("WarehouseId", "ReceiptDate", "CreatedAt")
                        .IsDescending(false, true, true);
            ...
            modelBuilder.Entity("StockLedgerRetail.Domain.Entities.InventoryDailyRollup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("OutboundQty30d")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
                    ...
                    b.HasIndex("BrandId", "SnapshotDate");

                    b.HasIndex("SnapshotDate", "BrandId", "WarehouseId", "RegionCode")
                        .IsUnique();

                    b.ToTable("inventory_daily_rollups", (string)null);
                });
            ...
            modelBuilder.Entity("StockLedgerRetail.Domain.Entities.PurchaseOrder", b =>
                {
                    ...
                    b.HasIndex("Status", "OrderDate", "CreatedAt")
                        .IsDescending(false, true, true);

                    b.HasIndex("WarehouseId", "OrderDate", "CreatedAt")
                        .IsDescending(false, true, true);
            ...
            modelBuilder.Entity("StockLedgerRetail.Domain.Entities.StockTransaction", b =>
                {
                    ...
                    b.HasIndex("ProductVariantId", "WarehouseId", "TransactionDate")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("IX_stock_transactions_outbound_pairs")
                        .HasFilter("\"TransactionType\" = 2");

                    b.HasIndex("WarehouseId", "TransactionDate", "CreatedAt")
                        .IsDescending(false, true, true);

                    b.HasIndex("ProductVariantId", "WarehouseId", "TransactionDate", "CreatedAt")
